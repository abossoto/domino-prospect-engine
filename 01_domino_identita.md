...
// ─── Generation System Builder (v3.2) ────────────────────────────────────────
...
// ─── Research Agent (agentic loop, max 20 iterations) ────────────────────────
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 2. Research agent (agentic multi-turn)
